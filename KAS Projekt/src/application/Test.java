...
public class Test {
    public static void main(String[] args) {
        ...
        Udflugt udflugt1 = new Udflugt("Egeskov", "19/5/2023", "Egeskov", 75, konference);
        Udflugt udflugt2 = new Udflugt("Trapholt Museum, Kolding", "20/5/2023", "Trapholt Museum", 200, konference);
